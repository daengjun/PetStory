                ...
                user.updatePassword(newPassword)
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    util.snackbar(SetPasswordActivity.this, "비밀번호가 변경되었습니다.", Snackbar.LENGTH_SHORT);
//                                    startToast("비밀번호가 변경되었습니다.");
                                    ...
                                    util.snackbar(SetPasswordActivity.this, "비밀번호 변경에 실패하였습니다.", Snackbar.LENGTH_SHORT);
//                                    startToast("비밀번호 변경에 실패하였습니다.");
                ...
                util.snackbar(SetPasswordActivity.this, "비밀번호가 일치하지 않습니다.", Snackbar.LENGTH_SHORT);
//                startToast("비밀번호가 일치하지 않습니다.");
            }
        } else {
            util.snackbar(SetPasswordActivity.this, "비밀번호를 확인해 주세요.(8~20 글자, 영문, 숫자, 특수문자 1자리 필수)", Snackbar.LENGTH_SHORT);
