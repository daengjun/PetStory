                                ...
                                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        if (k == 1 && j == 1) {
                                            ...
                                            Log.e(TAG, "재설정 메일 발송");
                                            util.snackbar(FindPasswordActivity.this, "비밀번호 재설정 이메일을 발송하였습니다.", Snackbar.LENGTH_SHORT);
//                                            startToast("비밀번호 재설정 이메일을 발송하였습니다.");
                                            finish();
                                        } else if (k == 0 && j == 0) {
                                            util.snackbar(FindPasswordActivity.this, "일치하는 Email이 없습니다.", Snackbar.LENGTH_SHORT);
//                                            startToast("일치하는 Email이 없습니다.");
                                        } else if (k == 1 && j == 0) {
                                            util.snackbar(FindPasswordActivity.this, "일치하는 닉네임이 없습니다.", Snackbar.LENGTH_SHORT);
//                                            startToast("일치하는 닉네임이 없습니다.");
                                        } else {
                                            util.snackbar(FindPasswordActivity.this, "비밀번호 재설정 이메일 발송에 실패하였습니다.", Snackbar.LENGTH_SHORT);
