...
public class ContentEditActivity extends AppCompatActivity {
    ...
    private static calbacklistener callBackListener;
        ...
        switch (requestCode) {
            case 0:
                if (resultCode == RESULT_OK) {
                    ...
                    Log.e("postImgPath", "postImgPath -> result fail");
                }
                break;
        }
    }
