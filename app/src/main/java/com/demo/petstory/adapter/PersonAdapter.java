...
import com.demo.petstory.activity.ChatActivity;
...
public class PersonAdapter extends RecyclerView.Adapter<PersonAdapter.ViewHolder> implements ItemTouchHelperListener, com.demo.petstory.util.calbacklistener {
    ...
    public PersonAdapter(Context mContext, calbacklistener calbacklistener) {
