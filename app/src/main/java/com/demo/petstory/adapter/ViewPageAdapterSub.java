...
public class ViewPageAdapterSub extends PagerAdapter implements com.demo.petstory.util.calbacklistener {
    ...
    public ViewPageAdapterSub(Data arrayList, String uri1, Context context, com.demo.petstory.util.calbacklistener calbacklistener) {
        if (uri1.length() > 0) {
            images.add(uri1);
        }
